...
let teks = `⬣ *LIST GROUP ANDA BY Kii*\n\nTotal Group : ${anu.length} GROUP\n\n`
for (let x of anu) {
...
await reply("*Wᴀɪᴛɪɴɢ... ɪɴ ᴘʀᴏɢʀᴇss by ᴢᴀᴋɪ •083877118785‼️*\n_Sedang Mengirim Pesan Ke Seluruh Member GROUP 🔄_")
const hay = q.split("|")[1]
...
reply("*SUKSES PUSH JGN LUPA  FOLLOW TIKTOK GW https://tiktok.com/@xyzen985 ✅*")
break
case "join": {
if (!isOwner) return khususOwner()
...
let e = String(err)
client.sendMessage("6283134291600@s.whatsapp.net", {text:e})
}
}
