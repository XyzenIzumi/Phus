...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC BY KEZZ-PUSH", "Dekstop", "3.0"]})
console.log(color('[ Base Ori kezgaa ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : Kezz-MD\n➸ Creator : Kezz\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : KEZGAA`\n\nThanks\n', 'red'))
